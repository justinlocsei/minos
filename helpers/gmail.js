...
/**
 * Generate a unique recipient address
 *
 * @returns {string}
 */
function buildUniqueAddress() {
  var parts = config.emailAddress.split('@');
  return `${parts[0]}+${uuid.v4()}@${parts[1]}`;
}

/**
 * Retrieve a message from the inbox
 *
 * This requires the unique recipient address that was generated by a call to
 * the `buildUniqueAddress` function.
 *
 * @param {string} recipient The unique recipient address
 * @returns {Promise}
 * @resolve {object} The raw message object
 */
function fetchMessage(recipient) {
...
module.exports = {
  buildUniqueAddress: buildUniqueAddress,
